...
const glowColorMap = {
  ...
  gold: { base: 54, spread: 200 } // Hue for #FEEC41
};
...
const GlowCard = ({ 
  children, 
  className = '', 
  glowColor = 'gold', // Default to gold variant
  size = 'md',
  width,
  height,
  customSize = false
  ...
  const getInlineStyles = () => {
    const baseStyles = {
      ...
      '--spread': spread,
      '--radius': '14',
      '--border': '0.5', // Ultra-fine hairline thickness
      '--backdrop': 'rgba(255, 255, 255, 0.6)',
      '--backup-border': '#FEEC41', // Requested yellow-gold
      '--size': '250',
      '--outer': '1',
